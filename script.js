...
function render() {
    ...
    drawRect(0, 0, canvas.width, canvas.height, "#0a7afa");
    drawNet();

    drawText(user.score, canvas.width / 4, canvas.height / 2, "WHITE", 120, 'bold');
    drawText(com.score, (3 * canvas.width) / 4, canvas.height / 2, "WHITE", 120, 'bold');
